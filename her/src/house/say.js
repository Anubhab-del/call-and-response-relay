...
function SayRoom({ answering: e, onClearAnswering: t }) {
  let n = useStore(),
  ...
  let g = (0, React.useMemo)(() => r.trim().split(/\s+/).filter(Boolean).length, [r]),
    ...
    S = () => {
      update((e) => {
        for (let t of e.replies) t.private || (t.sent = !0);
      });
    },
    C = async () => {
      if (l)
  ...
  return (0, jsx.jsxs)(`div`, {
    ...
    children: [
      (0, jsx.jsx)(motion.p, {
        className: `room-lede`,
        ...fadeIn(0, 0.6),
        children: `This page is yours. Nothing here goes anywhere until you send it, and the private ones never go anywhere at all.`,
      }),
      e
      ...
      (0, jsx.jsxs)(motion.div, {
        ...
        children: [
          ...
          (0, jsx.jsx)(`textarea`, {
            ...
            placeholder: e ? `Answer it however you like.` : `Anything. It does not have to be good.`,
            rows: 8,
            spellCheck: !0,
          }),
          (0, jsx.jsxs)(`div`, {
