    ...
    children: [
      ...
      (0, jsx.jsxs)(motion.section, {
        ...
        children: [
          ...
          (0, jsx.jsx)(`p`, {
            className: `fine`,
            children: `Everything you have written, as one file. If you change phones, open it here on the new one and nothing is lost.`,
          }),
          (0, jsx.jsxs)(`div`, {
            className: `row`,
            children: [
          ...
          storageBroken
            ? (0, jsx.jsx)(`p`, {
                className: `warn`,
                children: `This phone will not let the house save anything at the moment — the storage is full or switched off. You can still read everything. Do not write anything long until it is fixed.`,
              })
            : null,
        ],
      }),
      a && !isStandalone()
        ? (0, jsx.jsxs)(motion.section, {
            ...
            children: [
              ...
              (0, jsx.jsx)(`p`, {
                className: `fine`,
                children: `Then it opens with its own name and no browser around it, and it works with no signal.`,
              }),
              (0, jsx.jsx)(`div`, {
                className: `row`,
