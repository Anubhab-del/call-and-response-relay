...
function ReelRoom({ onWatch: e }) {
  ...
  return (0, jsx.jsxs)(`div`, {
    ...
    children: [
      (0, jsx.jsx)(`p`, {
        className: `room-lede`,
        children: `A hundred chapters, in four parts. About a quarter of an hour if you sit through it, and it keeps your place if you do not.`,
      }),
      i > 1
        ? (0, jsx.jsxs)(`button`, {
            type: `button`,
